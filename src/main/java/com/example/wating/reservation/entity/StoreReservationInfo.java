...
public class StoreReservationInfo {
  ...
  public StoreReservationInfo(Byte days, String times, Boolean isPossible, Integer capacity) {
    this.days = days;
    this.times = times;
  ...
  public boolean equals(Object o) {
    ...
    StoreReservationInfo storeReservationDayInfo = (StoreReservationInfo) o;
